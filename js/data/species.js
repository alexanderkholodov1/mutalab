// Catálogo base de razas del laboratorio. Cada raza define atributos base
// y una lista de razas con las que NO es compatible.
...
export function areCompatible(speciesA, speciesB) {
